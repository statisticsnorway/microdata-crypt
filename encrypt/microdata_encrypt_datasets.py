...
parser.add_argument(
    "-r",
    "--rsa_key_dir",
    help="The directory containing public key file microdata_public_key.pem",
    required=True,
)
parser.add_argument(
    "-d",
    "--dataset_dir",
    help="The directory containing the dataset files (csv) to encrypt (input).",
    required=True,
)
parser.add_argument(
    "-e",
    "--encrypted_dir",
    help="The directory containing the encrypted files (output).",
    required=True,
)
...
if not dataset_dir.exists():
    print(
        "Need to specify a directory containing the dataset files to encrypt."
    )
    raise SystemExit(1)
