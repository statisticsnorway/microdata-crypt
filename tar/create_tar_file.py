...
parser.add_argument(
    "-d", "--directory", help="The directory to tar.", required=True
)
parser.add_argument(
    "-n", "--tar_file_name", help="The name of the tar file", required=False
)
...
tar_file_name = (
    tar_file_name if tar_file_name.endswith(".tar") else f"{tar_file_name}.tar"
)
